    ...
    <>
      ...
      <h1 className='font-bold text-center text-lg'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className='cursor-pointer bg-violet-700 hover:bg-violet-900 disabled:bg-violet-700 p-2 py-1 text-sm font-bold text-white rounded-md'>Save</button>
          </div>
        </div>
